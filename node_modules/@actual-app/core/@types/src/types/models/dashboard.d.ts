...
export type AgeOfMoneyWidget = AbstractWidget<'age-of-money-card', {
    name?: string;
    conditions?: RuleConditionEntity[];
    conditionsOp?: 'and' | 'or';
    timeFrame?: TimeFrame;
...
type SpecializedWidget = NetWorthWidget | CashFlowWidget | SpendingWidget | BudgetAnalysisWidget | CrossoverWidget | MarkdownWidget | SummaryWidget | CalendarWidget | FormulaWidget | SankeyWidget | AgeOfMoneyWidget | BalanceForecastWidget;
...
export type SankeyWidget = AbstractWidget<'sankey-card', {
    name?: string;
    conditions?: RuleConditionEntity[];
    conditionsOp?: 'and' | 'or';
    timeFrame?: TimeFrame;
...
export type BalanceForecastWidget = AbstractWidget<'balance-forecast-card', {
    name?: string;
    startDate?: string;
    endDate?: string;
    accounts?: string[];
