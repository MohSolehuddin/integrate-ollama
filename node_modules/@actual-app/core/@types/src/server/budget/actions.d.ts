...
export declare function isTrackingBudget(): boolean;
...
export declare function copyUntilYearEnd({ month, category }: {
    month: string;
    category: string;
}): Promise<void>;
...
export declare function resetIncomeCarryover({ month }: {
    month: string;
}): Promise<void>;
