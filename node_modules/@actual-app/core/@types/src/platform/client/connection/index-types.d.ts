 ...
 */
export declare function send<K extends keyof Handlers>(name: K, args: Parameters<Handlers[K]>[0], options: {
    catchErrors: true;
}): Promise<{
 ...
 */
export declare function sendCatch<K extends keyof Handlers>(name: K, args?: Parameters<Handlers[K]>[0]): Promise<{
    data: Awaited<ReturnType<Handlers[K]>>;
    error: undefined;
} | {
    data: undefined;
 ...
 */
export declare function listen<K extends keyof ServerEvents>(name: K, cb: (arg: ServerEvents[K]) => void): () => void;
