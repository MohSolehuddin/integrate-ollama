...
export declare function init(channel: Window | number, // in electron the port number, in web the worker
handlers: Handlers): void;
export type Init = typeof init;
export declare function send<K extends keyof ServerEvents>(type: K, args?: ServerEvents[K]): void;
