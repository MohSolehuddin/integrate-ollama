import type { NewUserAccessEntity, UserAvailable, UserEntity } from '#types/models';
...
export declare const app: {
    ...
    method<Name extends string & keyof AdminHandlers>(name: Name, func: AdminHandlers[Name]): void;
