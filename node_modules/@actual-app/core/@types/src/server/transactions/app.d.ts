...
declare function moveTransaction({ id, accountId, targetId }: {
    id: string;
    accountId: string;
...
export declare const app: {
    ...
    method<Name extends string & keyof TransactionHandlers>(name: Name, func: TransactionHandlers[Name]): void;
